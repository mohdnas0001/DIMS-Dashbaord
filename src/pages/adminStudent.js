...
The department also shares a library/research laboratory which accommodates both e-library and physical books with the Department of Computer Science. The library/research laboratory is connected to the internet. Academic and technology staff offices are internet compliant and most offices are provided with inverter power system.`,
    ...
    return (
        <>
            <section className={`${(dept === null) && (edt === 0) ? 'w-[100%] pt-[3%] px-[2.5%] flex flex-col items-start gap-y-[3vw] pb-[3%]' : 'hidden'}`}>
                ...
                <section className={`aspect-[1/1.5] md:aspect-[1/0.3] sm:aspect-[1/0.4] w-[100%] flex flex-col justify-between`}>
                    <div className={`flex h-[85%] md:h-[70%] sm:h-[80%] w-[100%] flex-col items-center sm:flex-row sm:flex-wrap sm:justify-start md:flex-row md:flex-wrap md:justify-start gap-x-[6%] sm:gap-x-[5%] md:gap-x-[2%] gap-y-[2.5%] sm:gap-y-[10%] md:gap-y-[10%]`}>
                        <div onClick={() => select(0, 100)} className="bg-[#0D659F] w-[90%] sm:w-[30%] md:w-[23%] h-[18%] sm:h-[45%] md:h-[45%] rounded-[8px] flex flex-col items-center justify-center gap-y-[7%] cursor-pointer">
                            ...
                            <p className="text-[4.5vw] sm:text-[2.7vw] md:text-[2vw] font-semibold text-white font-[Montserrat]"><span>{student[0].length}</span> Courses</p>
                        </div>
                        <div onClick={() => select(1, 200)} className="bg-white w-[90%] sm:w-[30%] md:w-[23%] h-[18%] sm:h-[45%] md:h-[45%] rounded-[8px] shadow-[0.18vw_0.25vw_0.2vw_0_rgba(0,0,0,0.2)] flex flex-col items-center justify-center gap-y-[7%] cursor-pointer">
                            ...
                            <p className="text-[4.5vw] sm:text-[2.7vw] md:text-[2vw] font-semibold text-[#0D659F] font-[Montserrat]"><span>{student[1].length}</span> Courses</p>
                        </div>
                        <div onClick={() => select(2, 300)} className="bg-[#0D659F] w-[90%] sm:w-[30%] h-[18%] md:w-[23%] sm:h-[45%] md:h-[45%] rounded-[8px] flex flex-col items-center justify-center gap-y-[7%] cursor-pointer">
                            ...
                            <p className="text-[4.5vw] sm:text-[2.7vw] md:text-[2vw] font-semibold text-white font-[Montserrat]"><span>{student[2].length}</span> Courses</p>
                        </div>
                        <div onClick={() => select(3, 400)} className="bg-white w-[90%] sm:w-[30%] h-[18%] md:w-[23%] sm:h-[45%] md:h-[45%] rounded-[8px] shadow-[0.18vw_0.25vw_0.2vw_0_rgba(0,0,0,0.2)] flex flex-col items-center justify-center gap-y-[7%] cursor-pointer">
                            ...
                            <p className="text-[4.5vw] sm:text-[2.7vw] md:text-[2vw] font-semibold text-[#0D659F] font-[Montserrat]"><span>{student[3].length}</span> Courses</p>
                        </div>
                        <div onClick={() => select(4, 500)} className="bg-[#0D659F] w-[90%] h-[18%] sm:w-[30%] md:w-[23%] sm:h-[45%] md:h-[45%] rounded-[8px] flex flex-col items-center justify-center gap-y-[7%] cursor-pointer">
                            ...
                            <p className="text-[4.5vw] sm:text-[2.7vw] md:text-[2vw] font-semibold text-white font-[Montserrat]"><span>{student[4].length}</span> Courses</p>
                        </div>
                    </div>
                </section>
            </section>
            <div onClick={back1} className={`${(dept === null) ? 'hidden' : 'block'} w-[2%] aspect-square cursor-pointer max-[320px]:w-[7%] max-[460px]:w-[6%] max-[601px]:w-[5%] max-[860px]:w-[4%] max-[1280px]:w-[3%] mb-[3%]`}>
            ...
            <div className={`${(dept === null) ? 'hidden' : 'flex'} w-[100%] aspect-[1/0.04] justify-between items-center max-[640px]:aspect-[1/0.2] max-[640px]:flex-col max-[640px]:items-start mb-[2%]`}>
            ...
            <p className={`${(dept === null) ? 'hidden' : 'block'} font-[Montserrat] font-semibold text-[3vw] sm:text-[2.5vw] md:text-[2vw] xl:text-[2vw] text-black`}>{level} Level Student</p>
            <div className={`${(dept === null) ? 'hidden' : 'flex'} border-t border-x w-[100%] flex-col pt-[3%] mt-[3%]`}>
                <div className="w-[100%] flex flex-row gap-x-[10%] pl-[2%]">
                    ...
                    <div className="px-[1.5%] bg-[#F9F5FF] rounded-[3vw]">
                        <p className="text-[2.6vw] min-[480px]:text-[2vw] sm:text-[1.5vw] md:text-[1.2vw] font-semibold text-[#6941C6] font-[Montserrat]">{studentCount} Student</p>
                    </div>
                </div>
                ...
                <div className="w-[100%] mt-[2%] flex flex-row">
                    ...
                    {(windowWidth < 641) ?
                        <div style={{ height: `${(40 * (student[change].length)) + 40}px` }} className={`w-[57%] flex flex-col flex-wrap overflow-scroll max-[460px]:w-[45%]`}>
                            <div className="w-[120px] md:w-[12%] sm:w-[12%] flex flex-col">
                                <div className="w-[100%] h-[40px] bg-[#F9FAFB] flex justify-center items-center border-b">
                                    <p className="text-[2.6vw] min-[480px]:text-[2vw] font-medium text-[#667085] font-[Montserrat]">Matric</p>
                                </div>
                                {student[change].map((data, index) => (
                            ...
                            <div className="w-[120px] sm:w-[12%] md:w-[12%] flex flex-col">
                                <div className="w-[100%] h-[40px] bg-[#F9FAFB] flex justify-center items-center border-b">
                    ...
                    {(windowWidth > 641) ?
                        <div className="w-[28%] md:w-[28%] sm:w-[28%] flex flex-col">
                            <div className="w-[100%] h-[40px] md:aspect-[1/0.45] bg-[#F9FAFB] flex justify-center items-center border-b">
                                <p className="text-[1vw] font-medium text-[#667085] font-[Montserrat]">Matric</p>
                            </div>
                            {student[change].map((data, index) => (
            ...
            <section className={`${(edt === 1) ? 'flex' : 'hidden'} w-[100%] pt-[3%] pl-[2.5%] pr-[2.5%] flex-col items-start gap-y-[3vw] pb-[3%]`}>
                ...
                <div className="flex flex-col w-[100%] aspect-[1/0.5] gap-y-[10%] max-[640px]:aspect-[1/3.2] max-[640px]:gap-y-[1.2%] max-[1280px]:aspect-[1/0.8]">
                    ...
                    <div className="w-[90%] h-[40%] flex flex-row flex-wrap justify-between max-[640px]:h-[15%] gap-y-[5%]">
                        ...
                        <div className="w-[40%] h-[30%] max-[640px]:w-[80%] flex flex-col justify-center">
                            ...
                            <p className="text-[3.5vw] font-[Montserrat] font-semibold text-justify text-[#0D659F] sm:text-[2vw] md:text-[1.7vw] xl:text-[1.2vw]">{student[change][trsf].position}</p>
                        </div>
                        <div className="w-[40%] h-[30%] max-[640px]:w-[80%] flex flex-col justify-center">
                            ...
                            <p className="text-[3.5vw] font-[Montserrat] font-semibold text-justify text-[#0B8700] sm:text-[2vw] md:text-[1.7vw] xl:text-[1.2vw]">{student[change][trsf].status}</p>
                        </div>
                        <div className="w-[20%] h-[30%] max-[640px]:w-[80%] flex flex-col justify-center">
                        ...
                        <div className="w-[20%] h-[30%] max-[640px]:w-[80%] flex flex-col justify-center">
                            ...
                            <p className="text-[3.5vw] font-[Montserrat] font-semibold text-justify text-[#0D659F] sm:text-[2vw] md:text-[1.7vw] xl:text-[1.2vw]">{student[change][trsf].marital}</p>
                        </div>
                    </div>
                </div>
            </section>
